...
const Solado = require('../models/Solado')
...
controller.listar = async (req, res) => {
    try {
        let dados = await Solado.find() // Traz todos os Solados cadastrados
...
controller.obterUm = async (req, res) => {
    ...
    try {
        ...
        let obj = await Solado.findById(id)
...
controller.atualizar = async (req, res) => {
    try {
        ...
        let ret = await Solado.findByIdAndUpdate(id, req.body)
...
controller.excluir = async (req, res) => {
    try{
        ...
        let ret = await Solado.findByIdAndDelete(id)
